...
<div class="page-shell page-shell-inner">
  <section class="hero reveal">
    <div class="hero-copy">
      ...
      <p class="hero-kicker">
        ...
        with a particular interest in director-level opportunities in biopharma and evidence
        generation.
      </p>
      <p class="hero-text">
        ...
        help shape how high-quality real-world evidence gets generated.
      </p>
      <div class="hero-actions">
        <a class="button button-primary" href="experience.html">View Experience</a>
        <a class="button button-secondary" href="projects.html">Explore Projects/Tools</a>
      </div>
    </div>
  ...
  <section class="section section-intro reveal" id="about">
    ...
    <div class="split-text">
      ...
      <p>
        ...
        practical decision-making need to come together at scale.
      </p>
    </div>
  </section>
  ...
  <section class="section reveal">
    ...
    <div class="card-grid">
      ...
      <article class="info-card">
        <h3><a href="projects.html">Projects/Tools</a></h3>
        <p>Internal tooling interests, interactive easter eggs, and space for future R and AI work.</p>
      </article>
      <article class="info-card">
